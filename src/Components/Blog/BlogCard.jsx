...
const BlogCard = ({ title, blogimage }) => {
  return (
    <div>
      <div className="lg:w-[800px] md:w-[600px] md:justify-center md:items-center md:flex md:flex-col mx-5 lg:mx-20 md:mx-20 my-10 shadow-lg hover:cursor-pointer rounded-[12px] pb-10">
